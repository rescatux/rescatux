...
PACKAGES="${GNOME_MINIMAL_PACKAGES} zenity iceweasel xchat wmctrl syslinux pastebinit mbr ntfs-3g chntpw" # I add syslinux so that isohybrid command is recognised.
